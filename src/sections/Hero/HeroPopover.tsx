...
const HeroPopover = ({ productId }: Props) => {
  ...
  return (
    <div className="hero__popover flex items-center absolute top-1/3 left-full w-max z-[9999] bg-white before:absolute before:left-0 before:top-1/2 before:-translate-x-full before:-translate-y-1/2 before:w-0 before:h-0 before:border-t-[12px] before:border-t-transparent before:border-b-[12px] before:border-b-transparent before:border-r-[12px] before:border-r-gray2">
